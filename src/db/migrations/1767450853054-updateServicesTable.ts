...
export class UpdateServicesTable1767450853054 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "services" ADD "rating" numeric DEFAULT '4.85'`);
        await queryRunner.query(`ALTER TABLE "services" ADD "includesIn" json DEFAULT '{"in":[]}'`);
    }
