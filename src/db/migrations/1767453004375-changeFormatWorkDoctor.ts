...
export class ChangeFormatWorkDoctor1767453004375 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."users_formatwork_enum" AS ENUM('och', 'zoch')`);
        await queryRunner.query(`ALTER TABLE "users" ADD "formatWork" "public"."users_formatwork_enum" NOT NULL DEFAULT 'och'`);
